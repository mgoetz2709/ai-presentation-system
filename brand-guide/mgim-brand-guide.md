...
presentation pipeline (Maximilian, Veronika, Jürgen) reads this file directly — nobody
inlines a copy of it into their own prompt. If the CI changes, it changes here, once.
...
signature system"), not accidental filler. Veronika and Maximilian must use them as specified
in this guide. Do not "fix" this by removing the bars — that would be undoing an explicit
